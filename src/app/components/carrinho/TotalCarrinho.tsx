import ItemCarrinho from "@/app/data/model/ItemProduto"
...
export default function TotalCarrinho(props: TotalCarrinhoProps) {
    ...
    return (
        <div className="flex items-center justify-between w-5/6 bg-zinc-800 rounded-md p-7">
            <div className="flex flex-col justify-between">
                <span className=" text-zinc-500">Total</span>
                <span className="text-3xl font-bold text-yellow-500">R$ {total.toFixed(2)}</span>
            </div>
            <button className="bg-green-600 px-4 py-2 rounded-md text-xl text-white font-bold">Finalizar</button>
        </div>
    )
}